...
{
    [LocalizedDisplayName(nameof(Resources.TapActivityName))]
    [LocalizedDescription(nameof(Resources.TapActivityDesc))]
    public class Tap : CodeActivity
    {
        ...
        [LocalizedDescription(nameof(Resources.YDesc))]
